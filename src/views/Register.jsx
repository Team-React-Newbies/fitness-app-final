...
export default function Register() {
    ...
    const register = async () => {
        ...
        try {
            ...
            const credential = await registerUser(form.email, form.password, form.username, form.phone, photoUrl);
            const photoUrl = await uploadPhoto(photoFile, credential.user.uid);
            await createUserHandle(form.username, credential.user.uid, credential.user.email, form.phone, form.photoUrl);
